    ...
    <>
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
          ...
          scrolled
            ? "bg-white/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] border-b border-white/40"
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-5">
          ...
          {/* === Desktop Nav === */}
          <nav className="hidden md:flex items-center gap-10 text-[15px] font-semibold text-gray-900">
            <a href="#" className="hover:text-[#1D309D] transition-colors duration-200">
          ...
          <button
            ...
            className="relative z-50 p-2 rounded-xl hover:bg-gray-100/80 transition-all duration-200 focus:outline-none text-gray-900"
          ...
          <div className="border-t border-gray-200 bg-gray-50/50 px-8 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <p className="text-lg font-bold text-gray-900 mb-1">Join our Community</p>
