  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div
            className={`
              ...
              ${scrolled
                ? "max-w-4xl mx-auto bg-gray-900/95 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-gray-700/50 rounded-2xl px-8 py-4 justify-center"
                : "max-w-7xl mx-auto bg-transparent backdrop-blur-none shadow-none border border-transparent rounded-2xl px-6 py-5 justify-between"
              }
            `}
          >
            ...
            {/* Desktop nav links */}
            <nav className={`flex items-center font-semibold text-gray-100 ${scrolled ? "gap-8" : "gap-10"}`}>
              {[
      ...
      {menuOpen && (
        <>
          <div
            className="fixed top-4 left-4 right-4 md:top-6 md:left-6 md:right-6 z-[9999] max-w-5xl mx-auto opacity-100 visible translate-y-0 transition-all"
          >
            <div className="bg-gray-900 backdrop-blur-2xl rounded-3xl shadow-[0_24px_48px_rgba(0,0,0,0.5)] border border-gray-700/50 max-h-[90vh] overflow-y-auto overscroll-contain">

              {/* Close */}
              <div className="flex justify-end px-4 md:px-6 pt-4 md:pt-5 sticky top-0 bg-gray-900/95 backdrop-blur-sm z-10">
                <button
                  onClick={() => setMenuOpen(false)}
                  className="p-2 rounded-xl hover:bg-gray-800 transition-all text-gray-100"
                ...
                <nav className="flex flex-col justify-center space-y-1 md:space-y-2">
                  {[
                    ...
                    <a
                      ...
                      href="#"
                      onClick={() => setMenuOpen(false)}
                      className="group relative flex items-center justify-between px-4 md:px-6 py-3 md:py-4 rounded-xl hover:bg-[#1D309D] transition-all cursor-pointer"
                    >
              ...
              <div className="border-t border-gray-700/50 bg-gray-800/50 px-4 md:px-8 py-5 md:py-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      href="#"
                      className="w-11 h-11 md:w-12 md:h-12 bg-gray-800 hover:bg-[#1D309D] rounded-xl flex items-center justify-center transition-all duration-300 shadow-sm border border-gray-700 group"
