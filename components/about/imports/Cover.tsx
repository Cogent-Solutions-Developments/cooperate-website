  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={twMerge(
          // ✅ Always black text
          "text-neutral-900 font-semibold relative z-20 transition duration-200",
          className
        )}
      >
        {children}
...
export const CircleIcon = ({
  ...
  return (
    <div
      className={twMerge(
        `pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 group h-2 w-2 rounded-full bg-neutral-400 opacity-30`,
        className
      )}
    ></div>
  );
