    ...
    <>
      ...
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
          ...
          scrolled
            ? "bg-black/60 backdrop-blur-xl border-b border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)]"
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-5">
          ...
          <button
            ...
            className="relative z-50 p-2 rounded-xl hover:bg-white/10 transition-all duration-200 text-gray-100 focus:outline-none"
        ...
        <div className="bg-gradient-to-br from-[#0B0E1A]/95 via-[#111727]/95 to-[#1B2250]/90 backdrop-blur-2xl rounded-3xl shadow-[0_24px_64px_rgba(0,0,0,0.6)] border border-white/10 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 pt-2">
            ...
            <nav className="flex flex-col justify-center space-y-2">
              {[
                ...
                >
                  <span className="text-[15px] font-semibold text-gray-200 group-hover:text-white transition-colors duration-300">
                    {item}
                  </span>
                  <ChevronRight
                    size={18}
          ...
          <div className="border-t border-white/10 bg-[#0D1222]/80 px-8 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              {/* ✅ INLINE SVG SOCIAL ICONS (as in original NavBar) */}
